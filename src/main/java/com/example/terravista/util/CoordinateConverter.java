package com.example.terravista.util;
...
public class CoordinateConverter {
    ...
    /**
     * 国测局坐标系 (GCJ-02) 转 百度坐标系 (BD-09)
     */
    public static double[] gcj02ToBd09(double ggLon, double ggLat) {
        double z = Math.sqrt(ggLon * ggLon + ggLat * ggLat) + 0.00002 * Math.sin(ggLat * X_PI);
        double theta = Math.atan2(ggLat, ggLon) + 0.000003 * Math.cos(ggLon * X_PI);
